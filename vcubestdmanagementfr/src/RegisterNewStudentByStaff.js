...
function RegisterNewStudentByStaff(){
    ...
    useEffect(() => {
        const fetchCourses = async () => {
            try {
                ...
                setErrors('Error while fetching Courses');
            }
        };
        ...
        const fetchBatches = async () => {
            if (selectedCourse) {
                try {
                    ...
                    setErrors('Error while fetching Batches');
                }
            }
        };
    ...
    const handleRegister = async (e) => {
        ...
        try {
            await axios.post('http://127.0.0.1:8000/staff/registerstudent/', formData, {
                headers: {
            ...
            if (error['response']['status'] === 500){
                ...
                setErrors('SomeThing Went Wrong While submitting data');
            }
        }
    };
    return (
...
export default RegisterNewStudentByStaff;